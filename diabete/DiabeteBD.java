...
public class DiabeteBD extends SQLiteOpenHelper {
    ...
    void insertProtocole(Protocole protocole) {
        SQLiteDatabase db = this.getWritableDatabase(); //Ouverture de le BD

        ContentValues values = new ContentValues();
        values.put(KEY_ID_PRO, "1"); // ID du Protocole
        values.put(KEY_ID_GLY, "1"); // ID de la Glycémie ( Moins 0,60g)
        values.put(KEY_MATIN_GLY,"3");//
